...
-- Change to our gold schema
USE SCHEMA AIRFLOW_DB.GOLD;

-- Create stored procedures. These procedures will create new tables in gold schema
-- These are doing aggregations from tables created in silver schema
